...
public class RegistrationTask extends AsyncTask<Object, Object, Object>{
	...
	public RegistrationTask(String username, String password, String firstname, String lastname,
					String emailaddress){
	...
	protected Object doInBackground(Object... params) {
		...
		signup(user_name,userpassword,first_name,last_name,emailaddress);
		return null;
	}
	...
	protected void onPostExecute(Object result) {
		// TODO Auto-generated method stub
		try{
			RegistrationActivity.setRegister(RegisterSuccess);
			}catch(Exception e){
				e.printStackTrace();
			}
	...
	public void signup(String username, String password, String firstname, String lastname,
		...
		HttpPost httppost = new HttpPost("http://"+currentip.getIp()+"/android_connect/create_user.php");
		...
		try {
			...
			try {
				...
				RegisterSuccess = Integer.parseInt(success);
